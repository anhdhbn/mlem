...
import { Text, View, TouchableOpacity, StyleSheet, Image, Button, ScrollView } from 'react-native';
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.customerInfoView}>
        ...
        <TouchableOpacity>
          <Image source={PhoneIcon} style={{ width: 34, height: 34, top: 10, right: 5 }} />
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.btnView}>
        <Button title='Từ chối' style={{ width:146,
    height:48,color:'#C7C7C7'}}/>
        <Button title='Đồng ý' style={{ width:146,
    height:48,color:'##DC0000'}}/>
      </View>
    </ScrollView>
  )
}
